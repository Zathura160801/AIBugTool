...
public class AIBugToolDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        AIBugToolGlobalFeatureConfigurator.Configure();
        AIBugToolModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<AIBugToolDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<AIBugToolResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/AIBugTool");

            options.DefaultResourceType = typeof(AIBugToolResource);
        ...
        {
            options.MapCodeNamespace("AIBugTool", typeof(AIBugToolResource));
        });
    }
}
